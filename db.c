...
void 
db_setattr(db, flags, max_num_recs, name_size, def_size)
	struct database *db;
	int             flags;
	int             max_num_recs;
	int             name_size;
